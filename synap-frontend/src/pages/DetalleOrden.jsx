...
import { verOrden, cambiarEstado, cerrarOrden, asignarTecnico } from "../api/ordenes";
...
function DetalleOrden() {
  ...
  const [accion, setAccion] = useState(null);   // 'cerrar' | 'asignar' | null
  ...
  // El técnico solo puede operar sobre SUS órdenes, no sobre las de otro.
